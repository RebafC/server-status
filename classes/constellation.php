...
class constellation
{
    ...
    public function get_incidents($future = false, $offset = 0, $limit = 5, $timestamp = 0)
    {
        global $mysqli;
        if (0 === $timestamp) {
            $timestamp = time();
    ...
    public function render_warning($header, $message, $show_link = false, $url = null, $link_text = null): void
    {
        $this->render_alert('alert-warning', $header, $message, $show_link, $url, $link_text);
    }

    public function render_success($header, $message, $show_link = false, $url = null, $link_text = null): void
    {
     ...
     */
    public function render_alert($alert_type, $header, $message, $show_link = false, $url = null, $link_text = null): void
    {
        echo '<div><h1></h1>
