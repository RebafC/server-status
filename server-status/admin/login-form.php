  ...
  <div id="login-form" class="center">
    ...
    <form action="<?php echo WEB_URL; ?>/admin/" method="post">
          <div class="form-group">
            ...
            <input placeholder="<?php echo _('Email'); ?>" class="form-control" name="email" id="email" type="email" tabindex="1" value="<?php echo htmlspecialchars($_POST['email'] ?? '', ENT_QUOTES); ?>" required>
          </div>
