...
$visibility_id_value = $_POST['visibility_id'] ?? '';
...
?>
	<div class="form-group">
		<div class="col-sm-6"><label for="group"><?php
echo _('Service Group Name');
?>: </label><input type="text" maxlength="50" name="group" value="<?php
echo (isset($_POST['group'])) ? htmlspecialchars($_POST['group'], ENT_QUOTES) : $group_value;
?>" id="group" placeholder="<?php
echo _('service group name');
?>" class="form-control" required></div>
		<div class="col-sm-6"><label for="description"><?php
echo _('Description');
?>: </label><input type="text" maxlength="100" name="description" value="<?php
echo (isset($_POST['description'])) ? htmlspecialchars($description_value, ENT_QUOTES) : $description_value;
?>" id="description" placeholder="<?php
echo _('Description');
?>" class="form-control"></div>
	</div>
	<div class="form-group">
		<div class="col-sm-6">
			<label for="visibility_id"><?php
echo _('Visibility');
?>: </label>
			<select name="visibility_id" id="visibility_id" class="form-control">
				<?php
$visibility_id = empty($visibility_id_value) ? null : $visibility_id_value;
