...
?>
	<div class="form-group">
		<div class="col-sm-6"><label for="service"><?php
echo _('Service');
?>: </label><input type="text" maxlength="50" name="service" value="<?php
echo (isset($_POST['service'])) ? htmlspecialchars($_POST['service'], ENT_QUOTES) : $service_value;
?>" id="service" placeholder="<?php
echo _('service');
?>" class="form-control" required></div>
		<div class="col-sm-6"><label for="description"><?php
echo _('Description');
?>: </label><input type="text" maxlength="200" name="description" value="<?php
echo (isset($_POST['description'])) ? htmlspecialchars($_POST['description'], ENT_QUOTES) : $description_value;
...
echo _('Service Group');
?>: </label>
			<select name="group_id" id="group_id" class="form-control">
				<?php
$group_id = empty($group_id_value) ? null : $group_id_value;
