...
if (isset($_GET['delete'], $_GET['type'])) {
    if ('service' === $_GET['type']) {
        Service::delete();
    } elseif ('groups' === $_GET['type']) {
        ServiceGroup::delete();
    }
}
...
<section>
	...
	<?php if (0 === $user->get_rank()) {?> <a href="<?php echo WEB_URL; ?>/admin/?do=new-user" class="btn btn-success pull-right"><?php echo _('Add new user'); ?></a><?php }
	?>
	<div class="table-responsive">
		<table class="table">
