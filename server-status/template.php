...
class template
{
     ...
     * @param bool   $admin     decides whether to show admin menu
     */
    public static function render_header(string $page_name, $admin = false): void
    {
        if (!$admin) {
     ...
     * @param bool   $checked    will decide if the toggle will initially be on or off
     */
    public static function render_toggle($toggletext, $input_name, $checked): void
    {
        ?>
          <div>
  ...
  <?php
     ...
     * Renders footer.
     *
     * @param bool $admin decides whether to load admin scripts
     */
    public static function render_footer($admin = false): void
    {
        global $negotiator;
